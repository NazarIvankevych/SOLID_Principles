# Open Closed Principle (принцип розділення інтерфейсу): інтерфейси повинні бути невеликими та специфічними для потреб клієнтів, щоб не примушувати їх реалізувати зайві методи.
